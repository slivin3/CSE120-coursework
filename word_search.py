...
def word_search():
    ...
    statement = input("Enter a statement and we'll count the number of occurances of a word:") or Default_statement
    My_word = input("Enter a word and we'll count the number of occurances of in the previous statement:") or Default_My_word
